  ...
  return (
    <div className="my-[150px] flex flex-col items-center gap-14">
      <div className="flex flex-col items-center gap-6">
        ...
        <p className="text-content-body text-xl text-center">Junte-se à comunidade de criadores profissionais que já estão elevando <br />
      ...
      <div className="flex items-end gap-9">
        ...
        <div className="flex flex-col ">
          <div className="flex justify-center items-center rounded-tl-2xl p-2 w-[304px] bg-[linear-gradient(90deg,#4B2DBB_0%,#B5446B_100%)]">
